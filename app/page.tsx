...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "The AI industry's biggest deals — OpenAI, Nvidia, Microsoft, Anthropic, Amazon — form a surprisingly small cast of recurring characters moving enormous capital in circular patterns. This project catalogs those deals with structured analysis: incentive maps, a circular-financing rubric, and plain-language verdicts on what's real investment versus financial engineering.",
  ...
  },
  {
    ...
    description: "AI agents can leak information across boundaries they were never supposed to cross — one agent with access to sensitive data can expose it to agents (and users) that shouldn't have it. This project tests five distinct failure modes across five leading models and five industries, building a dashboard for the enterprise question: which AI is actually safe to deploy?",
    links: [
